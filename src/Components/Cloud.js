...
const Cloud = () => {
  return (
    <>
      <div className="bg-[url('Cloud-bg.png')] bg-cover">
        <section className="py-12 px-4 text-center ">
          <div className="container mx-auto">
            ...
            <p className="text-white mb-8">
              Get access to our world-className cloud services and take your
        ...
        <section className="py-12 px-4">
          <div className="container mx-auto my-[150px] flex flex-wrap">
            <div className="ml-[700px] mr-7 text-left font-serif">
              ...
              <p className="text-white mb-4">
                Contact us today to learn more about our cloud services and how
          ...
          <div className="flex flex-wrap -mx-4">
            <div className="w-full md:w-1/2 lg:w-1/3 px-4 mb-8">
              <div className="bg-white rounded-md shadow-md p-6">
                ...
                <p className="text-gray-700 mb-4">
                  We can help you move your applications and data to the cloud,
                  making it easier to scale your business and reduce costs.
                </p>
            ...
            <div className="w-full md:w-1/2 lg:w-1/3 px-4 mb-8">
              <div className="bg-white rounded-md shadow-md p-6">
                ...
                <p className="text-gray-700 mb-4">
                  Our team of experts can help you ensure that your cloud
                  infrastructure is secure and protected against cyber threats.
                </p>
                <a href="#" className="text-blue-500 hover:text-blue-600">
                  Learn More
                </a>
            ...
            <div className="w-full md:w-1/2 lg:w-1/3 px-4 mb-8">
              <div className="bg-white rounded-md shadow-md p-6">
                <h3 className="text-xl font-bold mb-4">Cloud Support</h3>
                <p className="text-gray-700 mb-4">
                  We provide 24/7 support to ensure that your cloud
                  infrastructure is always up and running smoothly.
                </p>
                <a href="#" className="text-blue-500 hover:text-blue-600">
                  Learn More
                </a>
